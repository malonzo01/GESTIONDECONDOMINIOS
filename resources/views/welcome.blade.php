...
<head>
    ...
    <meta name="keywords"
        content="condominios, condominios venezuela, condominio en linea, software administracion condominio, condominio web aplicacion" />
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <h1><img src="{{ asset('cvweb') }}/logo-condominios2.png" alt=""></h1>
                    </a>
                </div>
        ...
        <div id="main-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item" style="background-image: url(cvweb/images/slider/slider2-CV.jpg)">
                    <div class="carousel-caption">
                        <div>
                            <h2 class="heading animated bounceInDown">Ideal para administradores y juntas de
                                condominios...</h2>
                            <p class="animated bounceInUp">Es la herramienta perfecta para tu gestión administrativa,
                                flexible y poderosa<br>te permitirá administrar tu condominios de una forma fácil y
                                práctica.</p>
                            <a class="btn btn-default slider-btn animated fadeIn" href="#about-login">Iniciar
                                Sesión</a>
                        </div>
                    </div>
                </div>
                <div class="item" style="background-image: url(cvweb/images/slider/slider3-CV.jpg)">
                    <div class="carousel-caption">
                        <div>
                            ...
                            <p class="animated bounceInLeft">Diseño moderno y totalmente adaptable a la gran mayoria de
                                dispositivos</p>
        ...
        <div class="container">
            <div class="text-center">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <p>Es una aplicación 100% en línea diseñada para la administración de condominios y/o edificios. Es
                        la herramienta ideal para juntas de condominios autoadministradas o empresas de servicios
                        administrativos.</p>
                </div>
            </div>
            <div class="about-us">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#about" data-toggle="tab"><i
                                        class="fa fa-chain-broken"></i> Acerca de</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="about">
                                <div class="media">
                                    <img class="pull-left media-object" src="cvweb/images/about-us/about-CV.jpg"
                                        alt="Acerca de">
                                    <div class="media-body">
                                        <p>Nuestro sistema le(s) permitirá administrar su(s) condominio(s) en una forma
                                            fácil y práctica, además de brindar a los propietarios o residentes de cada
                                            condominio las facilidades para consultar su estatus de solvencia en cuanto
                                            a los pagos y la manera en como los recursos del condominio son
                                            administrados, esto proporciona transparencia y confianza en la gestión de
                                            la junta administradora.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="mission">
                                <div class="media">
                                    <img class="pull-left media-object" src="cvweb/images/about-us/mission-CV.jpg"
                                        alt="Misión">
                                    <div class="media-body">
                                        <p>Ofrecer un sistema adaptable tanto a juntas de condominios residenciales,
                                            administradoras de condominios, edificios. Garantizando en lo posible la
                                            disponibilidad de la aplicación en Internet, la integridad, confiabilidad y
                                            confidencialidad de los datos, así como el soporte continuo y oportuno para
                                            la solución de problemas y también para la incorporación de nuevos
                                            requerimientos con respuestas en el menor tiempo posible. </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="text-center">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a
                        href="http://mimenticos.com/" class="hover:underline">Mimenticos™</a>. Todos los derechos
                    reservados.
                </span>
            </div>
        </div>
