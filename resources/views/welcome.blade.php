...
<section id="about-us">
	...
	<footer id="footer">
		<div class="container">
			<div class="text-center">
				<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="http://mimenticos.com/"
                class="hover:underline">Mimenticos™</a>. Todos los derechos reservados.
        </span>
			</div>
		</div>
	</footer> <!--/#footer-->
